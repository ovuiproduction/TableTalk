...
def final_score(row_maxlen=1000,column_maxlen=11):
    global df
    df = pd.read_excel("static/files/predicted.xlsx")
    ...
    f_score = ((table_score*0.7) + (res_score*0.3))
    return table_score,res_score,total_score,f_score
